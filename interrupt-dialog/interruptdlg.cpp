...
#include "ui_interruptdlg.h"

InterruptDlg::InterruptDlg(QWidget *parent) :
    QDialog(parent),
 ...
 * 设置关闭按钮属性
 */
void InterruptDlg::setBtnCloseAttributes()
{
 ...
 * 设置标签显示图片属性
 */
void InterruptDlg::setlabInfoAttributes()
{
...
void InterruptDlg::setBtnKnowAttributes()
{
