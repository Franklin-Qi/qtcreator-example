    ...
    ui(new Ui::Widget)
{
    ...
    // 视频url: https://www.jianshu.com/p/9db0fd1579b6
    //player->setMedia(QUrl::fromLocalFile("../myvideowidget/video.WMV"));
    player->setMedia(QUrl::fromLocalFile("/home/yusq/example-qtcreator/src/13/video.wmv"));
//    player->setMedia(QUrl::fromLocalFile("../myvideowidget/video.mp4"));
    player->play();
